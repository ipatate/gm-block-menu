...
const Panel = ({
  ...
  const options = menus_categories ? menus_categories.map(e => ({
    label: e.name,
    value: e.id
  })) : [];
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_blockEditor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Settings", "gm-block-menu")
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Title", "gm-block-menu"),
    value: blocTitle,
    onChange: content => setAttributes({
      blocTitle: content
    })
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Category", "gm-block-menu"),
    value: categories,
    multiple: true,
    options: options,
    onChange: content => setAttributes({
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_blockEditor__WEBPACK_IMPORTED_MODULE_2__.PanelColorSettings, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Color settings"),
    colorSettings: [{
      value: backgroundColor.color,
      onChange: setBackgroundColor,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Background color", "gm-wrapper-full-text")
    }, {
      value: textColor.color,
      onChange: setTextColor,
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)("Text color", "gm-wrapper-full-text")
    }]
  })));
};
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)("goodmotion/block-menu", {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("GM Block Menu", "gm-block-menu"),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Block for display menu.", "gm-block-menu"),
  ...
  edit: (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.withColors)({
    ...
    return {
      ...
      menus_categories: select("core").getEntityRecords("taxonomy", "menus_categories", {
        per_page: 100
      })
    };
  })(props => {
